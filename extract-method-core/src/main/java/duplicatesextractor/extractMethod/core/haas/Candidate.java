package duplicatesextractor.extractMethod.core.haas;

import com.intellij.openapi.application.ApplicationManager;
import com.intellij.openapi.command.WriteCommandAction;
import com.intellij.psi.PsiMethod;
import com.intellij.psi.PsiStatement;
import duplicatesextractor.extractMethod.core.utils.StatementListUtil;
import org.apache.commons.lang3.StringUtils;
import org.jetbrains.annotations.NotNull;

import java.util.List;

import static duplicatesextractor.extractMethod.metrics.utils.DepthAnalyzer.getNestingArea;
import static duplicatesextractor.extractMethod.metrics.utils.DepthAnalyzer.getNestingDepth;
...
public class Candidate implements Comparable<Candidate> {
    ...
    public Candidate(List<PsiStatement> statements, PsiMethod psiMethod) {
        ...
        this.candidateAsString = StatementListUtil.listToString(this.statementList);
