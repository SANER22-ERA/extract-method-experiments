package duplicatesextractor.extractMethod.metrics;
...
import duplicatesextractor.extractMethod.metrics.features.Feature;
import duplicatesextractor.extractMethod.metrics.features.FeatureItem;
import duplicatesextractor.extractMethod.metrics.features.FeaturesVector;
import duplicatesextractor.extractMethod.metrics.utils.DepthAnalyzer;
import duplicatesextractor.extractMethod.metrics.utils.MemberSets;
...
public class MetricCalculator {
    ...
    private void methodFeatures() {
        ...
        int methodArea = DepthAnalyzer.getNestingArea(methodStr);
    ...
    private void metaFeatures() {
        ...
        int fragmentArea = DepthAnalyzer.getNestingArea(fragment);
